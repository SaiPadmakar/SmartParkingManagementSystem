...
if(mysqli_num_rows($result_cust)>0){
  echo '<div class="alert alert-warning" role="alert"><span class="glyphicon glyphicon-warning-sign"></span>  ALERT!! You already have a pending request, please be patient for some time your request will be approved soon by attender once checked!! <span class="glyphicon glyphicon-warning-sign"></span> </div>';
}else{
